	...
	<div class="login_page_wrapper">
		<div class="md-card" id="login_card">
			<div class="md-card-content large-padding" id="login_form">
				...
				<form action="{{ asset('/recover') }}" method="post">
					{{ csrf_field() }}
					<div class="uk-form-row">
						<label for="login_password">Шинэ нууц үг</label>
						<input class="md-input" type="password" id="login_password" name="password1" />
						<input type="hidden" name="id" value="{{ $row->id }}" />
					</div>
					<div class="uk-form-row">
						<label for="login_password">Нууц үг давтах</label>
						<input class="md-input" type="password" id="login_password" name="password2" />
					</div>
					<div class="uk-margin-medium-top">
						<button type="submit" class="md-btn md-btn-primary md-btn-block md-btn-large">Сэргээх</button>
					</div>
				</form>
				@endforeach
			</div>
